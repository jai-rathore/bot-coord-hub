...
const STEPS = [
  ...
  ["02", "It chases", "Replies, calendars, reminders."],
...
export default async function HomePage() {
  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      {/* No horizontal padding here: the feature rail bleeds to the screen edge
          on a phone so a half-visible next card shows it can be swiped. */}
